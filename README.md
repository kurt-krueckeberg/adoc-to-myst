...
> [!NOTE]
> The `--components-file` parameter specifies a YAML file that maps other Antora components to their
> folders. It is only necessary if your project has `xref:`'s that > reference other components, like
